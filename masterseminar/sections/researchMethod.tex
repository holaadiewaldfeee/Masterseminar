...
%interesting falsches wort! schreib nicht interesting, schrieb mehr wieso das Paper(Als Grund) für die Literaturrechearche ungeignet oder geeignet war. Da Interesting subjektiv wirkt und das willst du eigentlich nicht.
%stattdessen eine Beschreibung
%man will in research meth. immer eine gewisse grundlage dass andere das auch so nachmachen könnten wie ich

%Könntest du im Background erklären, Was ist ein Objekt, Klasse, Methode etc.(Schon hart banal das hier) ALSO KLASSEN ETC
